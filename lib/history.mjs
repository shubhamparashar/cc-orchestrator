...
const SECRET_PATTERNS = [
    ...
    // Slack incoming-webhook URLs — the path segments after /services/ are the
    // secret, so the whole credentialed path is collapsed.
    [/\bhttps:\/\/hooks\.slack\.com\/services\/[A-Za-z0-9/_+-]{20,}/gi, 'https://hooks.slack.com/services/‹redacted›'],
    // Google OAuth access tokens.
    [/\bya29\.[A-Za-z0-9_-]{20,}/g, '‹redacted-key›'],
    // npm access/automation tokens (npm_ + 36 chars; ≥30 stays clear of words
    // like npm_config, where an underscore breaks the alphanumeric run early).
    [/\bnpm_[A-Za-z0-9]{30,}\b/g, '‹redacted-key›'],
